          ...
          <header class="mt-70 absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between" aria-label="Global">
              <a href="#" class="text-2xl font-semibold leading-6 text-gray-900">Quem somos</a>
                ...
                <a href="#" class="text-2xl font-semibold leading-6 text-gray-900">Produtos</a>

                <a href="#" class="text-2xl font-semibold leading-6 text-gray-900">Cases</a>

                <a href="#" class="text-2xl font-semibold leading-6 text-gray-900">Missão</a>
            ...
            <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div class="flex">
                <div class="relative flex items-center gap-x-4 rounded-full py-1 px-4 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                  <span class="font-semibold text-indigo-600 text-3xl">Você usa dados ?</span>
